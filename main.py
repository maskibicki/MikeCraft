...
WALKING_SPEED = DEFAULT_WALK_SPEED
FLYING_SPEED = DEFAULT_FLY_SPEED * 2
...
class Window(pyglet.window.Window):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.walking_speed = DEFAULT_WALK_SPEED
        self.flying_speed = DEFAULT_FLY_SPEED
    ...
    def on_key_press(self, symbol, modifiers):
        ...
        if symbol == key.W:
            ...
            self.walking_speed = DEFAULT_WALK_SPEED*2
